...
- установить [zsh](https://www.zsh.org/)
- установить [oh-my-zsh](https://ohmyz.sh/)
- склонировать репозиторий в папку в которой у пользователя под которым работает консоль есть права на запись и чтение
- добавить в файл конфигурации `~/.zshrc` подключение скриптов

```bash
source path_to_folder/index.bash
```
...
Перейти на активную ветку в vcs
```bash
my branch
```
